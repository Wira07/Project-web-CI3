            ...
            <table class="table table-primary">
                <thead>
                    <tr>
                        ...
                        <th scope="col">
                            <a name="" id="" class="btn btn-primary" href="<?=base_url()?>index.php/DataCustomer/tambah"
                    ...
                    <tr class="">
                        ...
                        <td>
                            <a name="" id="" class="btn btn-primary"
                                href="<?=base_url()?>index.php/DataCustomer/edit/<?=$value->id_member?>"
                                role="button">Edit</a>
                            <a name="" id="" class="btn btn-danger"
                                href="<?=base_url()?>index.php/DataCustomer/hapus/<?=$value->id_member?>"
                                role="button">Hapus</a>
                        </td>
                    </tr>
                    <?php } ?>
