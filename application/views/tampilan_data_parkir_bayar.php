...
<body>
    ...
    ?>
        <form action="<?=base_url()?>index.php/DataParkir/bayar_proses/<?=$data->id_kendaraan?>" method="post">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <select name="jenis_kendaraan" id="" class="form-control">
                    ...
                    <option value="<?=$key->id_kategori?>" <?=($key->id_kategori == $data->id_kategori)?'selected':''?>>
                        <?=$key->nm_kategori?></option>
                    <?php } ?>
                </select>
            </div>
            <div class="mb-3">
                <label for="" class="form-label">Jam masuk</label>
                <input type="text" class="form-control" name="jam_masuk" id="" aria-describedby="jam_masuk"
                    placeholder="" value="<?=$data->jam_masuk?>">
            </div>
            <div class="mb-3">
                <label for="" class="form-label">Jam keluar</label>
                <input type="text" class="form-control" name="jam_keluar" id="" aria-describedby="jam_keluar"
                    placeholder="" value="<?=$data->jam_keluar?>">
            </div>
            <div class="mb-3">
                <label for="" class="form-label">Harga</label>
                <input type="text" class="form-control" name="harga" id="" aria-describedby="harga" placeholder=""
                    value="<?=$data->harga?>">
            </div>
            <div class="mb-3">
                <label for="" class="form-label">Bayar</label>
                <input type="text" class="form-control" name="bayar" id="" aria-describedby="bayar" placeholder=""
                    value="">
            </div>
            <input name="" id="" class="btn btn-primary" type="submit" value="Bayar">
        </form>
    </main>
    <footer>
        <!-- place footer here -->
